...
- Repository name: `misedeck-cardputer`
- Visibility: Public
- License: MIT
- Main language: C++
...
4. Use the repository name `misedeck-cardputer`.
5. Choose `Public`.
...
9. Open the prepared folder `MiseDeck_GitHub_Release_v1.0.0`.
...
4. Tag: `v1.0.0`.
5. Release title: `MiseDeck v1.0.0 EN / v1.1 PT-BR`.
6. Copy the text from `docs/RELEASE_NOTES_v1.0.0.md`.
7. Attach the binary files from:
   - `releases/v1.0.0/MiseDeck_Cardputer_v1.0.0_EN.bin`
   - `releases/v1.1.0-PTBR/MiseDeck_Cardputer_v1.1_PT-BR.bin`
   - `releases/MiseDeck_Public_Release_EN_PTBR.zip`
